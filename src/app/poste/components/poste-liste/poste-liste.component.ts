...
@Component({
  selector: 'app-poste-liste',
  templateUrl: './poste-liste.component.html',
  styleUrls: ['./poste-liste.component.scss']
})
export class PosteListeComponent implements OnInit {
  ...
  displayedColumns: string[] = ['province','description','actions'];
...
ngOnInit(): void {
  ...
  Edit(id:any){
    this.router.navigateByUrl('/postes/update/'+id);
  }
