...
@Component({
  selector: 'app-taxe-liste',
  templateUrl: './taxe-liste.component.html',
  styleUrls: ['./taxe-liste.component.scss']
})
export class TaxeListeComponent implements OnInit {
...
ngOnInit(): void {
  ...
  confirmBox(id:number){
    Swal.fire({
      title: 'Voulez-vous vraiment supprimer ce taxe?',
      icon: 'warning',
